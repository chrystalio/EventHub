...
**Key Models**: `User`, `Event`, `Registration`, `Certificate`
...
### Certificate System
Located in `app/Services/CertificateService.php`. Certificates can be generated from:
...
- HasManyThrough relationships bridge Event → Registration → RegistrationAttendee → Certificate
...
- The application uses Ray for debugging (`ray()` function) - visible throughout `CertificateService`
